...
class Agent:
    ...
    def learn(self):
        ...
        q_eval = torch.add(V_s_eval, (A_s_eval - torch.mean(A_s_eval, dim = 1, keepdim = True)))
...
for episode in range(EPISODES):
    ...
    if episode % 2 == 0:
        ...
        torch.save(agent.Q_eval.state_dict(), os.path.realpath(os.path.join(ROOT_DIR, "FLAPPY-BIRD-DDDQL.pt")))
